...
public final class KeyboardUtils {
    ...
    public static void showSoftInput() {
        InputMethodManager imm = (InputMethodManager) LiaoUtils.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    public static void showSoftInput(@NonNull final View view, final int flags) {
        InputMethodManager imm =
                (InputMethodManager) LiaoUtils.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    public static void hideSoftInputByToggle(final Activity activity) {
        ...
        if (Math.abs(delta) > INTERVAL_TIME && KeyboardUtils.isSoftInputVisible(activity)) {
